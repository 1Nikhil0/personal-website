const nikhil = () => {
  ...
  $(".js-nikhil").click(function (e) {
    e.preventDefault();
    Beacon("close");
    $(".js-nikhil").blur();
    $("#c-nikhil").removeClass("hide");
    $(".c-fab").addClass("hide");

    $("#c-new-content").empty();
    $(".c-nikhil__content .c-nikhil__options").removeClass("hide").addClass("active");
  });

  $(".js-nikhil-exit").click(function (e) {
    e.preventDefault();
    Beacon("close");
    $(".js-nikhil-exit").blur();
    $("#c-nikhil").addClass("hide");
  ...
  $(".c-nikhil__button").click(function (e) {
    var $this = $(this);
    e.preventDefault();
    ...
    var $answer = "#c-nikhil-q .c-nikhil__answer--" + $data;
    var $updated = "c-nikhil__answer--" + $id;
    var $location = "#c-new-content";
    var $buttons = ".c-nikhil__options";
